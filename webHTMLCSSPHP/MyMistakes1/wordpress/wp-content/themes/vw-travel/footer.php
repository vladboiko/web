  ...
  <div id="footer-2">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-8">
          <p><?php echo esc_html(get_theme_mod('vw_travel_footer_text',__('&copy; Copyright 2019 -','vw-travel'))); ?> <?php vw_travel_credit(); ?></p>
          <?php if( get_theme_mod( 'vw_travel_hide_show_scroll',true) != '') { ?>
            <?php $theme_lay = get_theme_mod( 'vw_travel_scroll_top_alignment','Right');
            if($theme_lay == 'Left'){ ?>
                <a href="#" class="scrollup left"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-travel' ); ?></span></a>
            <?php }else if($theme_lay == 'Center'){ ?>
                <a href="#" class="scrollup center"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-travel' ); ?></span></a>
            <?php }else{ ?>
                <a href="#" class="scrollup"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-travel' ); ?></span></a>
            <?php }?>
          <?php }?>
        </div>
