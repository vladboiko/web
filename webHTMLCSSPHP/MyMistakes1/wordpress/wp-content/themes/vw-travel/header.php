...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		<header role="banner">
  			<a class="screen-reader-text skip-link" href="#maincontent"><?php esc_html_e( 'Skip to content', 'vw-travel' ); ?></a>
		...
		<?php if(get_theme_mod('vw_travel_loader_enable',true)==1){ ?>
		  	<div id="preloader">
			    <div id="status">
			      <?php $theme_lay = get_theme_mod( 'vw_travel_loader_icon','Two Way');
