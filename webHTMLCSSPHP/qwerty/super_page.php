...
<body>
	...
	<div id="menu"> 
		<ol class="lo" >
			...
			<li><a href="samogon.php">Stool</a></li>
			<li><a href="samogon.php">Table</li>
			<li><a href="samogon.php">Bed</a></li>
			<li><a href="samogon.php">About us</a></li>
	...
	<div id="content_super">
		...
		<?php include "articles\wodka.txt";
