    ...
    <div class="entry-content">
        ...
        <div class="entry-attachment">
            <div class="attachment">
                <?php vw_travel_the_attached_image(); ?>
            </div>
        ...
        <?php
            the_content();
            wp_link_pages( array(
                'before' => '<div class="page-links">' . __( 'Pages:', 'vw-travel' ),
                'after'  => '</div>',
            ) );
        ?>
    </div>    
    <?php edit_post_link( __( 'Edit', 'vw-travel' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
