        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'vw-travel' ),
                ) );
            } elseif ( is_singular( 'post' ) ) {
                // Previous/next post navigation.
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'vw-travel' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'vw-travel' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'vw-travel' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Previous post:', 'vw-travel' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                ) );
            }
        ?>
